    ...
    <div class="register">
      <form action="">
        <ul class="form-info">
          ...
          <li><input type="text" id="code" placeholder="验证码" class="in-code">
            <input type="button" value="获取验证码" class="code-btn" onclick="send_code(this)"></li>
          <li><a class="submit-btn subm_btn" onclick="login()">立即注册</a></li>
        </ul>
      </form>
    </div>
  </div>
...
<div class="foot">
  <div class="foot-content">
    <!--  <img src="img/xl_logo.jpg" alt="" class="xl-logo">-->
