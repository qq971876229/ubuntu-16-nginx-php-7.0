...
<body class="gray-bg">
        ...
        {@each list as it,index}
			    			...
			    			<tr>
										...
										<td class="project-people">
                                            <a><img alt="image" class="img-circle" src="${it.img}"></a>
                                        </td>
       

										 <td class="project-actions">
                                             <a onclick="check('${it.id}');" class="btn btn-white btn-sm">
                                            <i class="fa fa-pencil"></i>审核</a>
                                        </td>
 ...
 <script id="show_vod" type="text/html">
     ...
     function check(id)
     {
        var show_vod_url = './index.php?_url=/mgr/user/check_live&uid='+id;
    ...
    {  
     ...
     var show_vod = document.getElementById('show_vod').innerHTML;
     ...
     function load()
     {
    	 ...
    	 post("/mgr/api/get_live_app_list",
    		{
