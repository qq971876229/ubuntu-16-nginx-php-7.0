  ...
  <div class="col-sm-12">
    ...
    <div class="ibox">
      ...
      <div class="ibox-title">
        {#<h5>用户</h5>#}
        <a href="./index.php?_url=/mgr/user/live_list&type=active">
          <div class="col-sm-4">活跃</div>
        </a>
        <a href="./index.php?_url=/mgr/user/live_list&type=goddess">
          <div class="col-sm-4">女神</div>
        </a>
        <a href="./index.php?_url=/mgr/user/live_list&type=newbie">
          <div class="col-sm-4">新人</div>
        </a>
      </div>
