...
class TLSSigAPI {
    ...
    public static function createSig($identifier, $expire = 180 * 24 * 3600)
    {
        $TLSSigAPI = new TLSSigAPI();
        
        return $TLSSigAPI->genSig($identifier,$expire);
    }
    ...
    public function genSig($identifier, $expire = 180 * 24 * 3600) 
    {
        ...
        $private = \config::app['live_private_key'];
        ...
        $public = \config::app['live_public_key'];
